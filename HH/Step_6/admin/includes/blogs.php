...
class blog{
	...
	public function create(){
		...
		$query = "INSERT INTO $this->table
		          SET v_blog_post_title = :blog_post_title,
		          	  v_blog_post_meta_title = :blog_post_meta_title,
		          	  v_blog_post_path = :blog_post_path,
		...
		//Bind data
		$stmt->bindParam(':blog_post_title',$this->v_blog_post_title);
		$stmt->bindParam(':blog_post_meta_title',$this->v_blog_post_meta_title);
		$stmt->bindParam(':blog_post_path',$this->v_blog_post_title);
	...
	public function update(){
		...
		$stmt->bindParam(':mai:image_url',$this->v_main_image_url);
